...
<body>
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="<?php echo base_url().'dashboard' ?>"><i class="fa fa-dashboard"></i> HomePage</a>
                    </li>
					<li>
                        <a href="<?php echo base_url().'barang'?>"><i class="fa fa-bar-chart-o"></i> Data Barang</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url().'operator'?>"><i class="fa fa-qrcode"></i> Login</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper" >
            ...
            <!-- /. PAGE INNER  -->
            <footer><p>UTS Pos PBKK</p></footer>
        </div>
        <!-- /. PAGE WRAPPER  -->
    </div>
    <!-- /. WRAPPER  -->
